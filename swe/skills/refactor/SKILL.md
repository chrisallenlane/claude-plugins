---
name: refactor
description: Aggressive iterative refactoring workflow. Scans codebase for opportunities, implements changes through SMEs, verifies with QA, commits atomically, and loops until no improvements remain.
model: opus
---

# Refactor - Aggressive Iterative Codebase Improvement
...
**Detect appropriate SME and spawn:**
- Go code: `swe-sme-golang`
- Dockerfile: `swe-sme-docker`
- Makefile: `swe-sme-makefile`
- GraphQL: `swe-sme-graphql`
- Ansible: `swe-sme-ansible`
- Zig: `swe-sme-zig`
- No specific SME: implement directly with general best practices
...
- Use `refactor:` prefix
- Summarize the category (e.g., "eliminate duplication in parser", "remove dead code")
...
- `/iterate` uses `swe-refactor` agent in advisory mode for code review
- `/refactor` uses `swe-refactor` agent as the core scanner in an autonomous loop
- Different use cases: feature development vs. codebase improvement
...
Starting aggressive refactoring of entire codebase...
